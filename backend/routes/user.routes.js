...
router.put("/community/question/update/:questionId", addQuestionValidator, handleFormError, updateQuestion);
router.delete("/community/question/delete/:questionId", deleteQuestion);
